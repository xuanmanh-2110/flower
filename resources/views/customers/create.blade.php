...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('customers.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" id="address" rows="3" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-rose-500 focus:ring focus:ring-rose-200 focus:ring-opacity-50" placeholder="Nhập địa chỉ đầy đủ">{{ old('address') }}</textarea>
        </div>
